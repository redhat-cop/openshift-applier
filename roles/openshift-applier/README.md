...
- object: <object_type>
  ...
  - name: <definition_name>
    ...
    tags: # Optional: Tags are only needed if `include_tags` or `skip_tags` is used
    - tag1
    - tag2
